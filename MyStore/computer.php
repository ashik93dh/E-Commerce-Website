    ...
    <body>
        ...
        <div class="productsection">
            <h2> Computer</h2>
             <?php
                                            $i=0;
                                            $query="Select * FROM products where product_cat='computer' order by product_id desc";
...
<button onClick="window.location='add_order.php?product_id=<?php echo $row['product_id'];?>& name=computer';">Add to cart</button>
              <?php } ?>
